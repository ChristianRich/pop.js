...
" size: "+this.getSize()+", index: "+this.index+", hasNext: "+this.hasNext()+", hasPrevious: "+this.hasPrevious()}};(function(c){var b=function(a){a=a||{};var d,f,h=!1,e=this,g=null;b.VERSION="1.0";b.NAME="Pop.js";b.CLASS_VISIBLE=a.classVisible||"visible";b.CLASS_HIDDEN=a.classHidden||"hidden";EventDispatcher.call(this);e.open=function(a,b){e.close();d=k(a,b);d.open()};e.close=function(){d&&(h=!1,d.close(),d=null)};e.add=function(a,b){f||(f=new ArrayIterator);f.push(k(a,b))};e.start=function(){f&&(e.close(),h=!0,f.reset(),d=f.next(),d.open())};e.next=function(){h&&f.hasNext()&&(d.close(),d=f.next(),d.open())};
e.previous=function(){h&&f.hasPrevious()&&(d.close(),d=f.previous(),d.open())};e.first=function(){h&&1!=f.getSize()&&(d.close(),d=f.first(),d.open())};e.last=function(){h&&1!=f.getSize()&&(d.close(),d=f.last(),d.open())};e.showOverlay=function(a){g=b.getTarget(a);b.removeClass(g,b.CLASS_HIDDEN);b.addClass(g,b.CLASS_VISIBLE)};e.hideOverlay=function(){g&&(b.removeClass(g,b.CLASS_VISIBLE),b.addClass(g,b.CLASS_HIDDEN),g=null)};var l=function(a){e.dispatchEvent(e.clone(a))},m=function(a){e.dispatchEvent(e.clone(a))},
k=function(a,d){if(!a)throw Error("Too few arguments.");var c=b.getTarget(a),c=new b.Dialogue(c,d||null);c.addEventListener("open",l);c.addEventListener("close",m);return c};c.addEventListener("keydown",function(a){switch(a.keyCode){case 27:e.close();break;case 38:e.first();break;case 40:e.last();break;case 37:e.previous();break;case 39:e.next()}},!1)};b.addClass=function(a,b){a.classList?a.classList.add(b):(b=b.replace(/(^\s+|\s+$)/g,""),a.className=a.className.replace(/(^\s+|\s+$)/g,""),a.className+=
" "+b)};b.removeClass=function(a,b){a.classList?a.classList.remove(b):(a.className=a.className.replace(RegExp("(\\s|^)"+b+"(\\s|$)")," "),a.className=a.className.replace(/(^\s+|\s+$)/g,""))};b.hasClass=function(a,b){return a.classList?a.classList.contains(b):!!a.className.match(RegExp("(\\s|^)"+b+"(\\s|$)"))};b.getTarget=function(a){if(!a)throw Error(b.NAME+": too few arguments.");var c;"[object String]"===Object.prototype.toString.apply(a)?c=document.querySelector?document.querySelector(a):document.getElementById(a):
"nodeType"in a&&(c=a);if(!c)throw Error(b.NAME+": unknown element "+a);return c};c.Pop=b})(window);Pop.Dialogue=function(c,b){EventDispatcher.call(this);this.el=c;this.data=b||null;var a=this;a.open=function(){a.isOpen()||(Pop.removeClass(c,Pop.CLASS_HIDDEN),Pop.addClass(c,Pop.CLASS_VISIBLE),a.dispatchEvent({type:"open",data:a.data,currentTarget:a.el}))};a.close=function(){a.isOpen()&&(Pop.removeClass(c,Pop.CLASS_VISIBLE),Pop.addClass(c,Pop.CLASS_HIDDEN),a.dispatchEvent({type:"close",data:a.data,currentTarget:a.el}))};a.isOpen=function(){return Pop.hasClass(c,Pop.CLASS_VISIBLE)};a.toString=function(){return"[Object Dialogue] "+
c.className}};
