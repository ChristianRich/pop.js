...
" size: "+this.getSize()+", index: "+this.index+", hasNext: "+this.hasNext()+", hasPrevious: "+this.hasPrevious()}};(function(c){var b=function(a){a=a||{};var d,f,e=this;b.VERSION="1.0";b.NAME="Pop.js";b.CLASS_VISIBLE=a.classVisible||"visible";b.CLASS_HIDDEN=a.classHidden||"hidden";EventDispatcher.call(this);e.open=function(a,b){e.close();d=g(a,b);d.open()};e.close=function(){d&&(d.close(),d=null)};e.add=function(a,b){f||(f=new ArrayIterator);f.push(g(a,b))};e.start=function(){f&&(e.close(),f.reset(),d=f.next(),d.open())};e.next=function(){d&&f&&f.hasNext()&&(e.close(),d=f.next(),d.open())};e.previous=function(){d&&
f&&f.hasPrevious()&&(e.close(),d=f.previous(),d.open())};e.first=function(){d&&(f&&1!=f.getSize())&&(e.close(),d=f.first(),d.open())};e.last=function(){d&&(f&&1!=f.getSize())&&(e.close(),d=f.last(),d.open())};var h=function(a){e.dispatchEvent(e.clone(a))},k=function(a){e.dispatchEvent(e.clone(a))},g=function(a,d){if(!a)throw Error("Too few arguments.");var c=b.getTarget(a),c=new b.Dialogue(c,d||null);c.addEventListener("open",h);c.addEventListener("close",k);return c};c.addEventListener("keydown",
